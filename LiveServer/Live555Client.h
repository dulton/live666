...
#define VLC_CODEC_UNDEF            VLC_FOURCC('u','n','d','f')
/* Video codec */
...
#define VLC_QUICK_VIDEO           VLC_FOURCC('Q','U','I','V')
...
#define VLC_QUICK_AUDIO                      VLC_FOURCC('Q','U','I','A')

/* muxed */
#define VLC_MUXED_ASF         VLC_FOURCC('A','S','F',' ')
#define VLC_MUXED_MP2P        VLC_FOURCC('M','P','2','P')
#define VLC_MUXED_MP2T        VLC_FOURCC('M','P','2','T')
#define VLC_MUXED_RAWDV       VLC_FOURCC('R','A','D','V')
...
public:
    ...
    public:
        typedef struct _media_format {
            //catalog of this track (audio/video/text vv...)
            uint8_t  i_cat;
